...
Exibir um Menu: Mostrar ao cliente o que está disponível.
Receber a Escolha: O usuário digita o que deseja.
Processar o Pagamento: Calcular o total e informar ao usuário.
🛠️ O que vamos usar?
